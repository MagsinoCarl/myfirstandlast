...
style namebox:
    xalign 0.22  # Set to 0.0 (left), 0.5 (center), or 1.0 (right)
    yalign 1.40 
    xoffset 50  # Adjust as needed for horizontal shift
    yoffset -150  # Adjust as needed for vertical shift
    padding (6, 2)
    color "#000000"
    background Frame("gui/namebox.png", 6, 6)  # Optional: use a custom background

style sec_namebox is namebox:
    xalign 0.80  # Set to 0.0 (left), 0.5 (center), or 1.0 (right)
    yalign 1.40 
...
screen right_hall_menu():
    ...
    frame:
        ...
        xpos 1500
        ypos 700
        textbutton "ACAD Office" action Jump("show_documents")
...
screen back_garden():
    frame:
        ...
        xpos 800    #  ← adjust these two numbers
        ypos 900#  ← until the box sits right over the door
        textbutton "Walk further" action Jump("back_garden_1")
...
screen right_hall_menu3():
    ...
    frame:
        ...
        ypos 1000         #  ← until the box sits right over the door
        textbutton "Go downstair" action Jump("second_floor_stair1")
...
screen fire():
    frame:
        ...
        ypos 900        #  ← until the box sits right over the door
        textbutton "Walk Further" action Jump("second_floor_menu")

    frame:
        background Frame("gui/nav_box.png", 15, 15)
        padding (20, 65)                                 # inner padding
        xpos 1995    #  ← adjust these two numbers
        ypos 750         #  ← until the box sits right over the door
    ...
    frame:
        ...
        textbutton "downstair" action Jump("right_hall_forward3")   
...
screen room():
    ...
    frame:
        background Frame("gui/nav_box.png", 15, 15)
        padding (20, 65)
        xpos 1850  #  ← adjust these two numbers
        ypos 700       #  ← until the box sits right over the door
...
screen fourth():
    frame:
        ...
        xpos 700    #  ← adjust these two numbers
        ypos 900        #  ← until the box sits right over the door
        textbutton "Computer Lab" action Jump("comlab")
...
screen fourth1():
    ...
    frame:
        ...
        xpos 1500    #  ← adjust these two numbers
        ypos 900        #  ← until the box sits right over the door
        textbutton "Lab Management" action Jump("lab_management")
...
screen fourth2():
    ...
    frame:
        ...
        xpos 1500    #  ← adjust these two numbers
        ypos 900        #  ← until the box sits right over the door
        textbutton "Kitchen Lab" action Jump("kitchen_lab")
    ...
    frame:
        ...
        xpos 1115  #  ← adjust these two numbers
        ypos 775        #  ← until the box sits right over the door
        textbutton "Walk Further" action Jump("fourth_floors4")
...
screen fourth4():
    frame:
        ...
        xpos 700    #  ← adjust these two numbers
        ypos 900        #  ← until the box sits right over the door
        textbutton "CSC Room" action Jump("student_org")
...
screen fourth5():
    frame:
        ...
        xpos 700    #  ← adjust these two numbers
        ypos 900        #  ← until the box sits right over the door
        textbutton "Travel and Tours" action Jump("travel_tours")
...
screen fourth6():
    frame:
        ...
        xpos 700    #  ← adjust these two numbers
        ypos 900        #  ← until the box sits right over the door
        textbutton "Standard Room" action Jump("travel_tours")
    ...
    frame:
        ...
        xpos 1115  #  ← adjust these two numbers
        ypos 775        #  ← until the box sits right over the door
        textbutton "Go downstair" action Jump("floor1_2")
